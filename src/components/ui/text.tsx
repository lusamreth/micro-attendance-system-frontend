...
const CONFIG = {
    ...
    smallheading: {
        tag: "h2",
        tw: "scroll-m-20 text-2xl font-bold tracking-tight",
    },
    title: {
        tag: "h3",
    ...
    body: {
        tag: "p",
        tw: "leading-6 text-sm font-normal",
    },
    small: {
        tag: "p",
...
export type TextVariant = keyof typeof CONFIG
...
export default function Text({
    ...
    const DynamicText = as ?? CONFIG[variant].tag
